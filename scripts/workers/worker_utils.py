...
URLS = {
    ...
    "get_challenge_by_title": "/api/challenges/challenge/by-title?title={}",
...
class EvalAI_Interface:
    def __init__(self, AUTH_TOKEN, EVALAI_API_SERVER, QUEUE_NAME, CHALLENGE_TITLE):
    ...
    def get_challenge_by_title(self):
        url = URLS.get("get_challenge_by_title").format(self.CHALLENGE_TITLE)
        url = self.return_url_per_environment(url)
        response = self.make_request(url, "GET")
        return response
